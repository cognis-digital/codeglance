#!/usr/bin/env sh
# Universal installer for codeglance. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/codeglance.git"
echo "Installing codeglance ..."

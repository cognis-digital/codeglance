...
[![PyPI](https://img.shields.io/pypi/v/cognis-codeglance.svg)](https://pypi.org/project/cognis-codeglance/)
[![CI](https://github.com/cognis-digital/codeglance/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/codeglance/actions)
...
CODEGLANCE exists for one job — repo onboarding map — architecture + hotspots for humans and agents — and does it without a SaaS bill or heavyweight setup.
...
```bash
codeglance --version
codeglance scan .                      # scan the current project
codeglance scan . --format json
codeglance scan . --fail-on high       # non-zero exit for CI gates
codeglance mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **code2flow**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`codeglance` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).

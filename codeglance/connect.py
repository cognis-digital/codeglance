"""Native cognis-connect emit for codeglance — forward findings to any platform.

Maps codeglance's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    codeglance ... --format json | codeglance-emit --to stix
    codeglance-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""

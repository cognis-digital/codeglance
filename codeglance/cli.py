"""CODEGLANCE command-line interface."""
from __future__ import annotations
import argparse, sys
from codeglance.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="codeglance", description="CODEGLANCE — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from codeglance.mcp_server import serve
        return serve()
    if args.cmd == "scan":

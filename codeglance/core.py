"""CODEGLANCE core — Repo onboarding map — architecture + hotspots for humans and agents."""
...
RULES = [
    ("COD-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("COD-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("COD-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
